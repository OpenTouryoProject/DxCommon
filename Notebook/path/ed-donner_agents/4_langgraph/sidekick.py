...
class Sidekick:
    ...
    def worker(self, state: State) -> Dict[str, Any]:
        ...
        # 以下、`4_lab4.ipynb`と比べ、使えるツールの説明が若干追加されている。
        system_message = f"""
    ...
    def evaluator(self, state: State) -> State:
        ...
        # 以下、`4_lab4.ipynb`と比べ、補助作業者が使えるツールの説明が若干追加されている。
        user_message = f"""
            ...
            The entire conversation with the assistant, with the user's original request and all replies, is: {self.format_conversation(state["messages"])}
    ...
    # `4_lab4.ipynb`では、process_messageと言う名前だった。
